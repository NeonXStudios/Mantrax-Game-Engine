...
# Variables
CXX = g++
CXXFLAGS +=  -std=c++20 -Wall -Wextra -pthread -DGLM_ENABLE_EXPERIMENTAL -D_DEBUG -Wattributes -D_CRT_SECURE_NO_WARNINGS -DWin32_LEAN_AND_MEAN -g -fPIC -m64 -DPX_PHYSX_COMMON_EXPORTS
...
LIB_DIR = -L$(GRAPHICS_FLAGS_LIBS) -L$(MATHS_FLAGS_LIBS) -L$(garin_core_includes_dir) -L$(AUDIO_FLAGS_LIBS) $(PHYSICS_LIBS) $(PHYSICS_LIBS_DLL) $(VRGARINLIBSDIR)
...
LIBS = $(GRAPHICS_LIBS) $(MATHS_LIBS) $(VRGARINLIBS) $(AUDIO_LIBS) $(PHYSICS_LIBS_FILES) $(PHYSICS_LIBS_FILES_DLL)
