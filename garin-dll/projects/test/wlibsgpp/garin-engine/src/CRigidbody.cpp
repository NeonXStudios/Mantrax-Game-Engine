...
void CRigidbody::draw(Entity *owner)
{
    ...
    {
        EditorGUI::Draw_Component<GBody>(owner, cmap, "Rigid Body", cmap->component_id, cmap, [cmap]() {});
        // cmap->isStatic = EditorGUI::Toggle("Static", cmap->isStatic);
        // cmap->useGravity = EditorGUI::Toggle("Dynamic", cmap->useGravity);
