...
void DynamicLibLoader::load_components()
{
    ...
    auto from_dll_path = FileManager::get_project_path() + "wlibsgpp/Compiler-Lib/GarinEditorEngine/Debug/MantraxRuntimeCore.dll";
    auto dll_path = FileManager::get_project_path() + "cpplibs/MantraxRuntimeCore.dll";
