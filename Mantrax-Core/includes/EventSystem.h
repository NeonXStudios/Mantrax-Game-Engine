...
{
public:
    static glm::vec2 screen_to_viewport(glm::vec2 ViewportRenderPosition, glm::vec2 WindowSize)
    {
        double x, y;
    ...
    static vec2 get_mouse_position_in_viewport(glm::vec2 ViewportRenderPosition, glm::vec2 WindowSize, glm::vec2 ScreenSize)
    {
        double x, y;
        glfwGetCursorPos(Gfx::get_game_window(), &x, &y);
    ...
    static glm::vec2 mouse_to_view_port_position(glm::vec2 ViewportRenderPosition, glm::vec2 WindowSize)
    {
        double x, y;
        glfwGetCursorPos(Gfx::get_game_window(), &x, &y);
        Camera *cam = SceneManager::get_current_scene()->main_camera;
    ...
    static glm::vec2 mouse_to_screen_pos(glm::vec2 ViewportRenderPosition, glm::vec2 WindowSize)
    {
        double x, y;
        glfwGetCursorPos(Gfx::get_game_window(), &x, &y);
